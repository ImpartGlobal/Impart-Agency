  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-brand":
          "linear-gradient(135deg, #F04B00 0%, #FF6B35 100%)",
        "noise":
      ...
      boxShadow: {
        "glow-orange": "0 0 40px -10px rgba(240, 75, 0, 0.4)",
        "glow-sm": "0 0 20px -5px rgba(240, 75, 0, 0.25)",
        "card": "0 1px 3px rgba(0,0,0,0.4), 0 1px 2px rgba(0,0,0,0.3)",
        "card-hover": "0 8px 30px rgba(0,0,0,0.5), 0 0 1px rgba(240,75,0,0.3)",
      },
    },
  },
  plugins: [],
